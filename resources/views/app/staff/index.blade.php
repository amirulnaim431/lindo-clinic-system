<x-internal-layout :title="'Staff'" :subtitle="'Team & Roles'">
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="text-sm text-slate-600">
            Create staff first so appointment scheduling can assign Doctor / Nurse / Beautician.
        </div>
            ...
            <table class="min-w-full text-sm">
                ...
                @forelse($staff as $s)
                    <tr>
                        ...
                        <td class="px-5 py-3 text-slate-700">{{ $roles[$s->role] ?? $s->role }}</td>
                        <td class="px-5 py-3">
                            @if($s->is_active)
                ...
                @empty
                    <tr>
                        <td class="px-5 py-8 text-center text-slate-500" colspan="4">
