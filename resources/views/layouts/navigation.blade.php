<nav class="min-h-screen bg-slate-50 text-slate-900">
        ...
        <aside class="hidden md:flex md:w-72 md:flex-col md:border-r md:border-slate-200 md:bg-white">
            <div class="flex h-16 items-center gap-3 border-b border-slate-200 px-6">
                <a href="{{ route('app.dashboard') }}" class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Lindo Clinic</div>
                        <div class="text-base font-bold text-slate-900">Internal App</div>
                    </div>
                </a>
            </div>
            ...
            <header class="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
                <div class="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('profile.edit') }}"
                           class="hidden sm:inline-flex items-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 transition">
                            Profile
                        </a>
                    </div>
                </div>
